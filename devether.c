/*
 * The A64 seems to have a bug where if there are any prints
 * during ether pnp, the ethernet doesn't work.
 * This should be kept in sync with ../port/devether.c until
 * someone figures it out.
 * The only difference is the print in etherprobe is removed.
 */
#include "u.h"
#include "../port/lib.h"
#include "mem.h"
